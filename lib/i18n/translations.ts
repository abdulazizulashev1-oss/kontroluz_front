...
export const translations: Record<Language, TranslationDictionary> = {
  uz: {
    ...
    contact: {
      ...
      mainOfficeTitle: "2-Filial: Chilonzor",
    ...
    branches: {
      ...
      mainOffice: {
        name: "2-Filial (Chilonzor)",
        badge: "2-Filial",
        address: "Toshkent shahri, Chilonzor tumani, Kontrol Markaziy Ombor Majmuasi",
        hours: "Dush-Juma: 09:00 - 18:00 | Shanba: 09:00 - 15:00",
      },
      openStatus: "Ochiq",
  ...
  ru: {
    ...
    contact: {
      ...
      mainOfficeTitle: "2-Филиал: Чиланзар",
    ...
    branches: {
      qorasaroy: {
        name: "1-Филиал (Карасарай)",
        badge: "1-Филиал",
        address: "г. Ташкент, Алмазарский район, ул. Карасарай 18",
        landmark: "Ориентир: перекресток Карасарай",
        hours: "Пн-Пт: 09:00 - 18:00 | Сб: 09:00 - 15:00",
      },
      mainOffice: {
        name: "2-Филиал (Чиланзар)",
        badge: "2-Филиал",
  ...
  en: {
    ...
    contact: {
      ...
      mainOfficeTitle: "Branch #2: Chilonzor",
    ...
    branches: {
      qorasaroy: {
        name: "Branch #1 (Qorasaroy)",
        badge: "Branch #1",
        address: "Tashkent, Olmazor district, Qorasaroy street 18",
        landmark: "Landmark: Qorasaroy intersection",
        hours: "Mon-Fri: 09:00 - 18:00 | Sat-Sun: 10:00 - 16:00",
      },
      mainOffice: {
        name: "Branch #2 (Chilonzor)",
        badge: "Branch #2",
        address: "Tashkent, Chilonzor district, Kontrol Central Warehouse Complex",
        hours: "Mon-Fri: 09:00 - 18:00 | Sat-Sun: 10:00 - 16:00",
      },
      openStatus: "Open",
